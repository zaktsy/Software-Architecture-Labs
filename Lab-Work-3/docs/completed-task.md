...
Необходимо создавать доказательства концепции перед началом разработки. Это позволяет проверить, насколько реализуема идея и какие технологии и инструменты могут быть использованы для ее реализации. По моему мнение, такой подод необходимо использовать в каждом проекте. Чтобы потом, после завершения разработки или на последних ее стадиях можно было понять, почему было принято то или иное архитектурное решение. Поэтому считаю рациональным его использование.